...
function Al(t2) {
  return Cc2(t2 = lc2(t2, vc2)), new Zh(t2, (e) => _l(t2, e));
}
function Rl(t2, e) {
  Cc2(t2 = lc2(t2, vc2));
  ...
  if (Array.isArray(n.indexes))
    for (const t3 of n.indexes) {
      const e2 = Pl(t3, "collectionGroup"), n2 = [];
      if (Array.isArray(t3.fields))
        for (const e3 of t3.fields) {
          const t4 = yh("setIndexConfiguration", Pl(e3, "fieldPath"));
...
export {
  ...
  jc2 as Bytes,
  Vc2 as CACHE_SIZE_UNLIMITED,
  yc2 as CollectionReference,
  mc2 as DocumentReference,
  Ph as DocumentSnapshot,
  Gc2 as FieldPath,
  Wc2 as FieldValue,
  vc2 as Firestore,
  ...
  gc2 as Query,
  Ch as QueryConstraint,
  bh as QueryDocumentSnapshot,
  Vh as QuerySnapshot,
  Rh as SnapshotMetadata,
  at as Timestamp,
  ml as Transaction,
  Zh as WriteBatch,
  vt as _DatabaseId,
  ...
  uc2 as _validateIsNotUsedTogether,
  ll as addDoc,
  Tl as arrayRemove,
  Il as arrayUnion,
  Oc2 as clearIndexedDbPersistence,
  pc2 as collection,
  Ic2 as collectionGroup,
  wc2 as connectFirestoreEmulator,
  hl as deleteDoc,
  yl as deleteField,
  Bc2 as disableNetwork,
  Tc2 as doc,
  Qc2 as documentId,
  Nc2 as enableIndexedDbPersistence,
  kc2 as enableMultiTabIndexedDbPersistence,
  $c2 as enableNetwork,
  Qh as endAt,
  Gh as endBefore,
  Cc2 as ensureFirestoreConfigured,
  _l as executeWrite,
  el as getDoc,
